...
<p>
	...
	<li>APFSDS: M829, M829A1, M829A2, M829A3, M829A4</li>
    	...
    	<li>GLATGM: LAHAT</li>
    	<li>Selectable rounds (up to four slots).</li>
...
<p>
	<ul> 
		<li>Selectable round types for four slots. You can even go with a pure APFSDS or HEAT loadout. <b>Be careful typing the round you want</b> because the mod will default to vanilla rounds (M833/M456A2) if there is a typo or if a field is left blank.</li>
		<li>Customize how many rounds per type are carried by the M1A1/E1 (total max of 50).</li>
...
<p>
	<ul> 
		...
		<li>XM1111 is in the config file but it is not implemented yet. Listing that in your loadout will make the mod use vanilla loadout (M833/M456). I only included it so there is no need to manually cleanup the config file if I could make it work.</li>
	</ul>
</p>
