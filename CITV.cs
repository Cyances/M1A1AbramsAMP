...
namespace M1A1AMP
{
    public class CITVCrosshair : MonoBehaviour
    {
        ...
        void Update()
        {
            if (cam_manager._currentCamSlot != null && cam_manager._currentCamSlot.gameObject.GetComponent<CITV>() != null)
            {
                ...
                if (M1A1AbramsAMPMod.citv_smooth.Value)
    ...
    public class CITV : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            nods.BaseBlur = M1A1AbramsAMPMod.perfect_citv.Value ? 0f : 0.05f;
            nods.OtherFovs = new float[] { 45f, 25f, 16.5f, 6.5f, 3.472f, 1.204f };
